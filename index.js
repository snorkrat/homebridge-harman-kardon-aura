...
module.exports = function(homebridge) {
  ...
  homebridge.registerAccessory("homebridge-harman-kardon-aura", "harman-kardon-aura", HarmanKardonAuraAccessory);
};
...
HarmanKardonAuraAccessory.Volume = function (volume, callback) {
...
HarmanKardonAuraAccessory.prototype = {
  ...
  setVolume: function(volume, callback) {
    ...
    var client = new net.Socket();
      if(volume){
            this.log("Volume Up");
            client.connect(this.port, this.ip, function() {
            client.write(buildRequest('void volumeup'));
            client.destroy();
            });
      } else {
            this.log("Volume Down");
            client.connect(this.port, this.ip, function() {
            client.write(buildRequest('void volumedown'));
            client.destroy();
            });
      }
      client.on('error', function(err){
  ...
  getServices: function() {
    ...
    var lightService = new Service.Lightbulb('Volume');
